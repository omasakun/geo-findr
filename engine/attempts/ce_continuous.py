...
from engine.lib.diffusion import Diffusion, SigmoidSchedule
...
class GeoModule(BaseLightningModule):
  def __init__(self, config: DotDict):
    ...
    self.diffusion = Diffusion(SigmoidSchedule(), self.config.diffusion_steps)
  ...
  def training_step(self, batch: Batch, batch_idx: int):
    ...
    noise_t = self.diffusion.random_continuous_t(targets)
